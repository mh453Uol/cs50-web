  ...
  new CacheFirst({
    ...
    plugins: [
      ...
      new ExpirationPlugin({
        ...
        maxAgeSeconds: ONE_DAY * 30 , // 30 days
  ...
  new CacheFirst({
    ...
    plugins: [
      ...
      new ExpirationPlugin({
        ...
        maxAgeSeconds: ONE_DAY * 7 , // 7 days
        purgeOnQuotaError: true
      })
    ]
  })
