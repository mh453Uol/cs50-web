        ...
        <table className="table" id="js-prayer-time-table">
          ...
          <tbody>
            <tr className={classNames({ "table-active": nextSalah === "Fajr"})}>
              ...
              <td id="js-fajr-start" className="text-center">{formatAsHoursMinutes(this.props.salah?.start.fajr)}</td>
              <td id="js-fajr-jamaat" className="text-center">{formatAsHoursMinutes(this.props.salah?.jamaat.fajr)}</td>
            </tr>
            <tr>
              <th scope="row">Sunrise</th>
              <td className="text-center" id="js-sunrise-start">{formatAsHoursMinutes(this.props.salah?.start.sunrise)}</td>
              <td className="text-center">-</td>
            </tr>
            <tr>
              <th scope="row">Dahawa Kubra</th>
              <td id="js-dahawa-kubra-start" className="text-center">{formatAsHoursMinutes(this.props.salah?.start.dahwakubra)}</td>
              <td className="text-center">-</td>
            </tr>
            <tr className={classNames({ "table-active": nextSalah === "Dhuhr"})}>
              <th scope="row">Dhuhr <span className="float-right">ظہر</span></th>
              <td id="js-dhuhr-start" className="text-center">{formatAsHoursMinutes(this.props.salah?.start.dhuhr)}</td>
            ...
            <tr className={classNames({ "table-active": nextSalah === "Maghrib"})}>
              ...
              <td id="js-magrib-start" className="text-center">{formatAsHoursMinutes(this.props.salah?.start.maghrib)}</td>
              <td className="text-center">-</td>
            </tr>
            <tr className={classNames({ "table-active": nextSalah === "Isha"})}>
              <th scope="row">Isha <span className="float-right">عشاء</span></th>
              <td id="js-isha-start" className="text-center">{formatAsHoursMinutes(this.props.salah?.start.isha)}</td>
              <td id="js-isha-jamaat" className="text-center">{formatAsHoursMinutes(this.props.salah?.jamaat.isha)}</td>
            </tr>
            <tr className={classNames({ "table-active": nextSalah === "1st Jummah"})}>
              <th scope="row">Jummah 1 <span className="float-right">جمعہ</span></th>
              <td colSpan={2} className="text-center" id="js-jummah1-jamaat">{formatAsHoursMinutes(this.props.salah?.jamaat.jummah1)}</td>
            </tr>
            <tr className={classNames({ "table-active": nextSalah === "2nd Jummah"})}>
              <th scope="row">Jummah 2 <span className="float-right">جمعہ</span></th>
              <td colSpan={2} className="text-center" id="js-jummah2-jamaat">{formatAsHoursMinutes(this.props.salah?.jamaat.jummah2)}</td>
            </tr>
          </tbody>
        </table>
      </div>
