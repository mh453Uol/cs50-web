            ...
            <div className="card">
                <div className="card-body" style={{ padding: "0.25rem" }}>
                    <div className="card-text next-salah">
                        <button onClick={props.onYesterdayClick} className="btn btn-primary yesterday" type="button">
                            {/* Left Icon */}
                        ...
                        <button onClick={props.onTomorrowClick} className="btn btn-primary tomorrow" type="button">
                            {/* Right Icon */}
